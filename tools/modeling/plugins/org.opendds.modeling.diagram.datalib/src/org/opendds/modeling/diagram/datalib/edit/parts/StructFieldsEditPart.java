...
import org.opendds.modeling.diagram.datalib.edit.policies.StructFieldsCanonicalEditPolicy;
import org.opendds.modeling.diagram.datalib.edit.policies.StructFieldsItemSemanticEditPolicy;
 ...
 * @generated
 */
public class StructFieldsEditPart extends ListCompartmentEditPart {
	 ...
	 * @generated
	 */
	public StructFieldsEditPart(View view) {
		super(view);
	}
	...
	public String getCompartmentName() {
		return Messages.StructFieldsEditPart_title;
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new StructFieldsItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE, new CreationEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new StructFieldsCanonicalEditPolicy());
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == OpenDDSDataLibElementTypes.Field_3003) {
				return this;
			}
