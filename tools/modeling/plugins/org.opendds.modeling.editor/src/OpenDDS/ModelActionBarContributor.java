 ...
 * @generated
 */
public class ModelActionBarContributor extends
	...
	protected IAction showPropertiesViewAction = new Action(
			EditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
		@Override
		public void run() {
			try {
	 ...
	 * @generated
	 */
	protected IAction refreshViewerAction = new Action(EditorPlugin.INSTANCE
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(EditorPlugin.INSTANCE
				.getString("_UI_ModelEditor_menu"), "OpenDDSMenuID");
		...
		//
		createChildMenuManager = new MenuManager(EditorPlugin.INSTANCE
				.getString("_UI_CreateChild_menu_item"));
		submenuManager.insertBefore("additions", createChildMenuManager);

		// Prepare for CreateSibling item addition or removal.
		//
		createSiblingMenuManager = new MenuManager(EditorPlugin.INSTANCE
	...
	public void menuAboutToShow(IMenuManager menuManager) {
		...
		submenuManager = new MenuManager(EditorPlugin.INSTANCE
				.getString("_UI_CreateChild_menu_item"));
