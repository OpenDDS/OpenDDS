 ...
 * @generated
 */
public class ApplicationTargetItemProvider extends EntityItemProvider implements
	...
	protected void addComponent_typePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_ApplicationTarget_component_type_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_ApplicationTarget_component_type_feature",
						"_UI_ApplicationTarget_type"),
				ModelPackage.Literals.APPLICATION_TARGET__COMPONENT_TYPE, true,
	...
	protected void addLanguagePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_ApplicationTarget_language_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_ApplicationTarget_language_feature",
						"_UI_ApplicationTarget_type"),
				ModelPackage.Literals.APPLICATION_TARGET__LANGUAGE, true,
				false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
				null));
	}
	...
	protected void addPlatformPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_ApplicationTarget_platform_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_ApplicationTarget_platform_feature",
						"_UI_ApplicationTarget_type"),
				ModelPackage.Literals.APPLICATION_TARGET__PLATFORM, true,
				false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
				null));
	}
	...
	protected void addParticipantsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_ApplicationTarget_participants_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_ApplicationTarget_participants_feature",
						"_UI_ApplicationTarget_type"),
				ModelPackage.Literals.APPLICATION_TARGET__PARTICIPANTS, true,
	...
	protected void addService_argumentsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_ApplicationTarget_service_arguments_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_ApplicationTarget_service_arguments_feature",
						"_UI_ApplicationTarget_type"),
				ModelPackage.Literals.APPLICATION_TARGET__SERVICE_ARGUMENTS,
	...
	public String getText(Object object) {
		ComponentType labelValue = ((ApplicationTarget) object)
				.getComponent_type();
