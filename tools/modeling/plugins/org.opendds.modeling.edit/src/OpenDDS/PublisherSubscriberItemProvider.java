...
/**
 * This is the item provider adapter for a {@link OpenDDS.PublisherSubscriber} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PublisherSubscriberItemProvider extends DomainEntityItemProvider
	...
	protected void addEntity_factoryPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PublisherSubscriber_entity_factory_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_PublisherSubscriber_entity_factory_feature",
						"_UI_PublisherSubscriber_type"),
				ModelPackage.Literals.PUBLISHER_SUBSCRIBER__ENTITY_FACTORY,
	...
	protected void addPresentationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_PublisherSubscriber_presentation_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_PublisherSubscriber_presentation_feature",
						"_UI_PublisherSubscriber_type"),
				ModelPackage.Literals.PUBLISHER_SUBSCRIBER__PRESENTATION, true,
	...
	protected void addGroup_dataPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_PublisherSubscriber_group_data_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_PublisherSubscriber_group_data_feature",
						"_UI_PublisherSubscriber_type"),
				ModelPackage.Literals.PUBLISHER_SUBSCRIBER__GROUP_DATA, true,
				false, true, null, null, null));
	}
	...
	protected void addPartitionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_PublisherSubscriber_partition_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_PublisherSubscriber_partition_feature",
						"_UI_PublisherSubscriber_type"),
				ModelPackage.Literals.PUBLISHER_SUBSCRIBER__PARTITION, true,
				false, true, null, null, null));
	}
	...
	protected void addTransportPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_PublisherSubscriber_transport_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_PublisherSubscriber_transport_feature",
						"_UI_PublisherSubscriber_type"),
				ModelPackage.Literals.PUBLISHER_SUBSCRIBER__TRANSPORT, true,
				false, true, null, null, null));
	}
