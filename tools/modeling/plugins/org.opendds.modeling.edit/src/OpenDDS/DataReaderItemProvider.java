 ...
 * @generated
 */
public class DataReaderItemProvider extends DataReaderWriterItemProvider
	...
	protected void addTopicPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_DataReader_topic_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_DataReader_topic_feature", "_UI_DataReader_type"),
				ModelPackage.Literals.DATA_READER__TOPIC, true, false, true,
				null, null, null));
	}
	...
	protected void addReader_data_lifecyclePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_DataReader_reader_data_lifecycle_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_DataReader_reader_data_lifecycle_feature",
						"_UI_DataReader_type"),
				ModelPackage.Literals.DATA_READER__READER_DATA_LIFECYCLE, true,
	...
	protected void addTransport_priorityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_DataReader_transport_priority_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_DataReader_transport_priority_feature",
						"_UI_DataReader_type"),
				ModelPackage.Literals.DATA_READER__TRANSPORT_PRIORITY, true,
				false, true, null, null, null));
	}
	...
	protected void addDurability_servicePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_DataReader_durability_service_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_DataReader_durability_service_feature",
						"_UI_DataReader_type"),
				ModelPackage.Literals.DATA_READER__DURABILITY_SERVICE, true,
				false, true, null, null, null));
	}
	...
	protected void addOwnership_strengthPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_DataReader_ownership_strength_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_DataReader_ownership_strength_feature",
						"_UI_DataReader_type"),
				ModelPackage.Literals.DATA_READER__OWNERSHIP_STRENGTH, true,
				false, true, null, null, null));
	}
