...
public class MultiTopicDataTypeEditPart extends ListCompartmentEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new MultiTopicDataTypeItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(OpenDDSDcpsLibVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new MultiTopicDataTypeCanonicalEditPolicy());
	}
	...
	protected void handleNotificationEvent(Notification notification) {
		...
		if (TopicsPackage.eINSTANCE.getMultiTopic_Datatype().equals(feature) && (type == Notification.SET)) {
