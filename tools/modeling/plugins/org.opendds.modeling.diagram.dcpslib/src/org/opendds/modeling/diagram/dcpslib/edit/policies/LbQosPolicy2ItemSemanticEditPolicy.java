...
import org.opendds.modeling.diagram.dcpslib.edit.parts.LbQosPolicyDuration2EditPart;
import org.opendds.modeling.diagram.dcpslib.edit.parts.Period3EditPart;
 ...
 * @generated
 */
public class LbQosPolicy2ItemSemanticEditPolicy extends OpenDDSDcpsLibBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public LbQosPolicy2ItemSemanticEditPolicy() {
		super(OpenDDSDcpsLibElementTypes.LbQosPolicy_3041);
	}
	...
	private void addDestroyChildNodesCommand(ICompositeCommand cmd) {
		...
		for (Iterator nit = view.getChildren().iterator(); nit.hasNext();) {
			...
			case LbQosPolicyDuration2EditPart.VISUAL_ID:
				for (Iterator cit = node.getChildren().iterator(); cit.hasNext();) {
					...
					case Period3EditPart.VISUAL_ID:
