...
import org.opendds.modeling.model.enumerations.HistoryQosPolicyKind;

/**
 * @generated
 */
public class HistoryQosPolicyKindEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public HistoryQosPolicyKindEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.DIRECT_EDIT_ROLE, new EnumDirectEditPolicy(HistoryQosPolicyKind.class));
	...
	public IParser getParser() {
		if (parser == null) {
			parser = OpenDDSPolicyLibParserProvider.getParser(OpenDDSPolicyLibElementTypes.HistoryQosPolicy_2027,
					getParserElement(), OpenDDSPolicyLibVisualIDRegistry.getType(
							org.opendds.modeling.diagram.policylib.edit.parts.HistoryQosPolicyKindEditPart.VISUAL_ID));
		}
		return parser;
	}
