 ...
 * @generated
 */
public class DsQosPolicyHistory_kindEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = OpenDDSPolicyLibParserProvider.getParser(OpenDDSPolicyLibElementTypes.DsQosPolicy_2023,
					getParserElement(), OpenDDSPolicyLibVisualIDRegistry.getType(
							org.opendds.modeling.diagram.policylib.edit.parts.DsQosPolicyHistory_kindEditPart.VISUAL_ID));
		}
		return parser;
	}
