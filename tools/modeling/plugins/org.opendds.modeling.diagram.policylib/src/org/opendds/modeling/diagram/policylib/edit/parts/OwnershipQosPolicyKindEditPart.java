 ...
 * @generated
 */
public class OwnershipQosPolicyKindEditPart extends CompartmentEditPart
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.DIRECT_EDIT_ROLE,
				new EnumDirectEditPolicy(OwnershipQosPolicyKind.class));
	...
	public IParser getParser() {
		if (parser == null) {
			parser = OpenDDSPolicyLibParserProvider
					.getParser(
							OpenDDSPolicyLibElementTypes.OwnershipQosPolicy_2032,
							getParserElement(),
							OpenDDSPolicyLibVisualIDRegistry
									.getType(org.opendds.modeling.diagram.policylib.edit.parts.OwnershipQosPolicyKindEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new EnumDirectEditManager(this, EnumDirectEditManager
					.getCellEditorClass(), OwnershipQosPolicyKind.class));
		}
		return manager;
	}
