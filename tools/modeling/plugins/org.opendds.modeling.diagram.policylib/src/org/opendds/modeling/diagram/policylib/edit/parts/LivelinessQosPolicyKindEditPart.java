...
import org.opendds.modeling.model.enumerations.LivelinessQosPolicyKind;

/**
 * @generated
 */
public class LivelinessQosPolicyKindEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public LivelinessQosPolicyKindEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.DIRECT_EDIT_ROLE, new EnumDirectEditPolicy(LivelinessQosPolicyKind.class));
	...
	public IParser getParser() {
		if (parser == null) {
			parser = OpenDDSPolicyLibParserProvider.getParser(OpenDDSPolicyLibElementTypes.LivelinessQosPolicy_2030,
					getParserElement(), OpenDDSPolicyLibVisualIDRegistry.getType(
							org.opendds.modeling.diagram.policylib.edit.parts.LivelinessQosPolicyKindEditPart.VISUAL_ID));
		}
		return parser;
	}
