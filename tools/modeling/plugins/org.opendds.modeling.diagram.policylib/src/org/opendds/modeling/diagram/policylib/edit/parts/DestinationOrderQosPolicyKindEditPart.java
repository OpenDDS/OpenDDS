 ...
 */
package org.opendds.modeling.diagram.policylib.edit.parts;
...
import org.opendds.modeling.diagram.policylib.edit.policies.OpenDDSPolicyLibTextSelectionEditPolicy;
import org.opendds.modeling.diagram.policylib.part.OpenDDSPolicyLibVisualIDRegistry;
import org.opendds.modeling.diagram.policylib.providers.OpenDDSPolicyLibElementTypes;
import org.opendds.modeling.diagram.policylib.providers.OpenDDSPolicyLibParserProvider;

import com.ociweb.gmf.EnumDirectEdit.EnumDirectEditManager;
import com.ociweb.gmf.EnumDirectEdit.EnumDirectEditPolicy;
import org.opendds.modeling.model.enumerations.DestinationOrderQosPolicyKind;

/**
 * @generated
 */
public class DestinationOrderQosPolicyKindEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public DestinationOrderQosPolicyKindEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new OpenDDSPolicyLibTextSelectionEditPolicy());
		installEditPolicy(EditPolicy.DIRECT_EDIT_ROLE, new EnumDirectEditPolicy(DestinationOrderQosPolicyKind.class));
	...
	public IParser getParser() {
		if (parser == null) {
			parser = OpenDDSPolicyLibParserProvider.getParser(
					OpenDDSPolicyLibElementTypes.DestinationOrderQosPolicy_2022, getParserElement(),
					OpenDDSPolicyLibVisualIDRegistry.getType(
							org.opendds.modeling.diagram.policylib.edit.parts.DestinationOrderQosPolicyKindEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new EnumDirectEditManager(this, EnumDirectEditManager.getCellEditorClass(),
					DestinationOrderQosPolicyKind.class));
		}
		return manager;
	}
	...
	protected void performDirectEdit(Point eventLocation) {
		if (getManager().getClass() == EnumDirectEditManager.class) {
			((EnumDirectEditManager) getManager()).show(eventLocation.getSWTPoint());
		}
	}
