...
import org.opendds.modeling.model.enumerations.DurabilityQosPolicyKind;

/**
 * @generated
 */
public class DurabilityQosPolicyKindEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public DurabilityQosPolicyKindEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.DIRECT_EDIT_ROLE, new EnumDirectEditPolicy(DurabilityQosPolicyKind.class));
	...
	public IParser getParser() {
		if (parser == null) {
			parser = OpenDDSPolicyLibParserProvider.getParser(OpenDDSPolicyLibElementTypes.DurabilityQosPolicy_2024,
					getParserElement(), OpenDDSPolicyLibVisualIDRegistry.getType(
							org.opendds.modeling.diagram.policylib.edit.parts.DurabilityQosPolicyKindEditPart.VISUAL_ID));
		}
		return parser;
	}
