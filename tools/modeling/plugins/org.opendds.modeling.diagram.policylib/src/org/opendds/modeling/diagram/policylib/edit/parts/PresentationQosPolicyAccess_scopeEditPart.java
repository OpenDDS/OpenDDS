...
import org.opendds.modeling.model.enumerations.PresentationQosPolicyAccessScopeKind;
 ...
 * @generated
 */
public class PresentationQosPolicyAccess_scopeEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public PresentationQosPolicyAccess_scopeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.DIRECT_EDIT_ROLE,
				new EnumDirectEditPolicy(PresentationQosPolicyAccessScopeKind.class));
	...
	public IParser getParser() {
		if (parser == null) {
			parser = OpenDDSPolicyLibParserProvider.getParser(OpenDDSPolicyLibElementTypes.PresentationQosPolicy_2034,
					getParserElement(), OpenDDSPolicyLibVisualIDRegistry.getType(
							org.opendds.modeling.diagram.policylib.edit.parts.PresentationQosPolicyAccess_scopeEditPart.VISUAL_ID));
		}
		return parser;
	}
