 ...
 * @generated
 */
public class DsQosPolicyHistory_kindEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public DsQosPolicyHistory_kindEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.DIRECT_EDIT_ROLE,
				new EnumDirectEditPolicy(HistoryQosPolicyKind.class));
	...
	public IParser getParser() {
		if (parser == null) {
			parser = OpenDDSPolicyLibraryParserProvider
					.getParser(
							OpenDDSPolicyLibraryElementTypes.DsQosPolicy_2023,
							getParserElement(),
							OpenDDSPolicyLibraryVisualIDRegistry
									.getType(org.opendds.modeling.model.opendds.diagram.policylibrary.edit.parts.DsQosPolicyHistory_kindEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new EnumDirectEditManager(this, EnumDirectEditManager
					.getCellEditorClass(), HistoryQosPolicyKind.class));
		}
		return manager;
	}
