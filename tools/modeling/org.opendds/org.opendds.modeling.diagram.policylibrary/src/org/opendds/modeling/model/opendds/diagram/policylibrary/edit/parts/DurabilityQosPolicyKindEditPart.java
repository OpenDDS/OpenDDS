	...
	public IParser getParser() {
		if (parser == null) {
			parser = OpenDDSPolicyLibraryParserProvider
					.getParser(
							OpenDDSPolicyLibraryElementTypes.DurabilityQosPolicy_2024,
							getParserElement(),
							OpenDDSPolicyLibraryVisualIDRegistry
									.getType(org.opendds.modeling.model.opendds.diagram.policylibrary.edit.parts.DurabilityQosPolicyKindEditPart.VISUAL_ID));
		}
		return parser;
	}
