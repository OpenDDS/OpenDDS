	...
	public IParser getParser() {
		if (parser == null) {
			parser = OpenDDSPolicyLibraryParserProvider
					.getParser(
							OpenDDSPolicyLibraryElementTypes.ReliabilityQosPolicy_2036,
							getParserElement(),
							OpenDDSPolicyLibraryVisualIDRegistry
									.getType(org.opendds.modeling.model.opendds.diagram.policylibrary.edit.parts.ReliabilityQosPolicyKindEditPart.VISUAL_ID));
		}
		return parser;
	}
