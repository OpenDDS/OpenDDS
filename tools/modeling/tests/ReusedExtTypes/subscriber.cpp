...
#include "model/ReusedExtTypesTraits.h"
...
int ACE_TMAIN(int argc, ACE_TCHAR** argv)
{
  try {
    ...
    ReusedExtTypesLib::DefaultReusedExtTypesType model(application, argc, argv);

    using OpenDDS::Model::ReusedExtTypesLib::Elements;
