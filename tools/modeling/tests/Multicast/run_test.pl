...
$pub_opts = "$mc_opts -ORBDebugLevel 10 -ORBLogFile publisher.log -DCPSDebugLevel 10";
$sub_opts = "$mc_opts -DCPSTransportDebugLevel 6 -ORBDebugLevel 10 -ORBLogFile subscriber.log -DCPSDebugLevel 10";
