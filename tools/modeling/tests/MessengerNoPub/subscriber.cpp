...
#include "model/MessengerNoPub_T.h"
...
ACE_THROW_SPEC((CORBA::SystemException))
{
  MessengerNoPub::MessageDataReader_var reader_i =
    MessengerNoPub::MessageDataReader::_narrow(reader);
  ...
  MessengerNoPub::Message message;
  DDS::SampleInfo info;
