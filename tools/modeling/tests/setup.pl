...
my @dirs = qw(Arrays CompositeKey DomainZero ExternalPolicies InvalidNames Messenger MessengerDpQos MessengerGlobalNs MessengerMixed MessengerMulti MessengerNoPub MessengerNoSub MessengerPubQos MessengerSplit MessengerWriterQos MultiInstance PolicyLib ReaderQos Sequences SubscriberQos TopicQos);
