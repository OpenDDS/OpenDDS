...
my $dst  = 'data.txt';
my $sport = PerlACE::random_port();
my $pport = PerlACE::random_port();

my $subscriber = new PerlACE::Process('subscriber', "-p $sport -s $pport");
my $publisher  = new PerlACE::Process('publisher',  "-p $pport -s $sport");
