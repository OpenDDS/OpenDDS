...
namespace
{
  ...
  struct concat
  {
    ...
    void operator() (const string &sub) {str_ += sub + sep_;}
    string &str_;
    char sep_;
  };
    ...
    const char *extends = "")
  {
    ...
    switch (jft)
      {
      case JCLASS:          classkeyw = "class"; break;
      case JINTERFACE:      classkeyw = "interface"; break;
      case JABSTRACT_CLASS: classkeyw = "abstract class"; break;
      case JFINAL_CLASS:    classkeyw = "final class"; break;
      }
...
std::string idl_mapping_java::type (AST_Type *decl)
{
  switch (decl->node_type ())
    ...
    case AST_Decl::NT_string: return "String";
    case AST_Decl::NT_enum:
    case AST_Decl::NT_interface:
    case AST_Decl::NT_native:
    case AST_Decl::NT_union:
    case AST_Decl::NT_struct: return scoped (decl->name ());
    case AST_Decl::NT_typedef:
      {
...
namespace
{ //"ju" helper functions: Java Unsigned type conversion
  ...
  ostream &operator<< (ostream &o, AST_Expression::AST_ExprValue *ev)
  {
    switch (ev->et)
      ...
      case AST_Expression::EV_ushort:     o << ju_s (ev->u.usval); break;
      case AST_Expression::EV_long:       o << ev->u.lval; break;
      case AST_Expression::EV_ulong:      o << ju_l (ev->u.ulval); break;
      case AST_Expression::EV_longlong:   o << ev->u.llval << 'L'; break;
      case AST_Expression::EV_ulonglong:
                                        o << ju_ll (ev->u.ullval) << 'L'; break;
  ...
  AST_Expression::ExprType type, AST_Expression::AST_ExprValue *ev)
{
  ...
  switch (type)
    ...
    case AST_Expression::EV_ushort:     type_str = "short"; break;
    case AST_Expression::EV_long:
    case AST_Expression::EV_ulong:      type_str = "int"; break;
    case AST_Expression::EV_longlong:
    case AST_Expression::EV_ulonglong:  type_str = "long"; break;
    case AST_Expression::EV_float:      type_str = "float"; break;
    case AST_Expression::EV_double:     type_str = "double"; break;
    case AST_Expression::EV_char:
    case AST_Expression::EV_wchar:      type_str = "char"; break;
    case AST_Expression::EV_octet:      type_str = "byte"; break;
    case AST_Expression::EV_bool:       type_str = "boolean"; break;
    case AST_Expression::EV_string:
    case AST_Expression::EV_wstring:    type_str = "String"; break;
    case AST_Expression::EV_longdouble:
...
namespace
{
    ...
    const AST_Union::DefaultValue &dv)
  {
    switch (udisc_type)
      {
      case AST_Expression::EV_short:      os << dv.u.short_val; break;
      case AST_Expression::EV_ushort:     os << dv.u.ushort_val; break;
      case AST_Expression::EV_long:       os << dv.u.long_val; break;
      case AST_Expression::EV_ulong:      os << dv.u.ulong_val; break;
      case AST_Expression::EV_char:       os << dv.u.char_val; break;
      case AST_Expression::EV_wchar:      os << dv.u.wchar_val; break;
      case AST_Expression::EV_bool:
