...
int main (int argc, char *argv[]) {
  ...
  try {
    ...
    Topic_Manager quoter_topic_manager (
      new Topic_Manager_T <StockQuoter::QuoteTypeSupportInterface,
	                   StockQuoter::QuoteTypeSupport> (
        QUOTER_QUOTE_TOPIC));

    // create a topic manager, related to the exchange topic
    Topic_Manager exchange_topic_manager (
       new Topic_Manager_T <StockQuoter::ExchangeEventTypeSupportInterface,
                            StockQuoter::ExchangeEventTypeSupport> (
