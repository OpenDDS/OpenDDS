 ...
 * @generated
 */
public class HistoryQosPolicyKindEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = OpenDDSPolicyLibParserProvider
					.getParser(
							OpenDDSPolicyLibElementTypes.HistoryQosPolicy_2027,
							getParserElement(),
							OpenDDSPolicyLibVisualIDRegistry
									.getType(org.opendds.modeling.model.opendds.diagram.policylib.edit.parts.HistoryQosPolicyKindEditPart.VISUAL_ID));
		}
		return parser;
	}
