...
int do_reader(DDS::DomainParticipant_var participant, DDS::Topic_var topic)
{
  // Create Subscriber
...
int do_writer(DDS::DomainParticipant_var participant, DDS::Topic_var topic)
{
...
ACE_TMAIN(int argc, ACE_TCHAR *argv[])
{
  try {
    ...
    switch (mode) {
    case READER:
      return do_reader(participant, topic);
      break;
    case WRITER:
      return do_writer(participant, topic);
      break;
    }
