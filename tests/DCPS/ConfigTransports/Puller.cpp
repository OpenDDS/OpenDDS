...
Puller::Puller(const Factory& factory,
  ...
  , sub_(factory.subscriber(dp_))
  , reader_(factory.reader(sub_, topic_, listener))
{
}
...
Puller::pull(const ACE_Time_Value& /*duration*/)
{
  ...
  // TODO(sonndinh): Why set PUBLICATION_MATCHED_STATAUS?
