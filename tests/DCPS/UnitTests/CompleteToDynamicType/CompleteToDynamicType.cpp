...
TEST(CompleteToDynamicType, MyInnerStruct)
{
  ...
  expected_dtm->descriptor_->name = "l";
  expected_dtm->descriptor_->id = false;
  ...
  long_td->name = "Int32";
  expected_dtm->descriptor_->type = long_expected_dt;
...
TEST(CompleteToDynamicType, MyOuterStruct)
{
  ...
  expected_outer_dtm->descriptor_->name = "ms";
  expected_outer_dtm->descriptor_->id = 0;
  ...
  expected_inner_dtm->descriptor_->name = "l";
  expected_inner_dtm->descriptor_->id = 0;
  ...
  long_td->bound.length(0);
  long_td->name = "Int32";
  expected_inner_dtm->descriptor_->type = long_expected_inner_dt;
  expected_outer_dtm->descriptor_->type = expected_inner_dt;
...
TEST(CompleteToDynamicType, MyAliasStruct)
{
  ...
  for (ACE_CDR::ULong i = 0; i < expected_alias_dt->get_descriptor()->base_type->get_member_count(); ++i) {
    XTypes::DynamicTypeMember_rch dtm;
...
TEST(CompleteToDynamicType, PrimitiveKind)
{
  ...
  first_expected_dtm->descriptor_->name = "TK_INT32";
  first_expected_dtm->descriptor_->id = UINT32_MAX;
  first_expected_dtm->descriptor_->index = 0;
  first_expected_dtm->descriptor_->is_default_label = 1;
  first_expected_dtm->descriptor_->try_construct_kind = XTypes::DISCARD;
  XTypes::DynamicTypeMember_rch second_expected_dtm = DCPS::make_rch<XTypes::DynamicTypeMember>();
  second_expected_dtm->descriptor_->name = "TK_CHAR8";
  second_expected_dtm->descriptor_->id = UINT32_MAX;
  second_expected_dtm->descriptor_->index = 1;
  second_expected_dtm->descriptor_->try_construct_kind = XTypes::DISCARD;
  first_expected_dtm->descriptor_->type = expected_dt;
  second_expected_dtm->descriptor_->type = expected_dt;
...
TEST(CompleteToDynamicType, MyUnion)
{
  ...
  long_expected_dtm->descriptor_->name = "l";
  long_expected_dtm->descriptor_->id = 0;
  long_expected_dtm->descriptor_->index = 0;
  long_expected_dtm->descriptor_->try_construct_kind = XTypes::DISCARD;
  long_expected_dtm->descriptor_->label.length(1);
  long_expected_dtm->descriptor_->label[0] = 0;
  long_expected_dtm->descriptor_->is_default_label = 0;
  XTypes::DynamicTypeMember_rch char_expected_dtm = DCPS::make_rch<XTypes::DynamicTypeMember>();
  char_expected_dtm->descriptor_->name = "c";
  char_expected_dtm->descriptor_->id = 1;
  char_expected_dtm->descriptor_->index = 1;
  char_expected_dtm->descriptor_->try_construct_kind = XTypes::DISCARD;
  char_expected_dtm->descriptor_->label.length(1);
  char_expected_dtm->descriptor_->label[0] = 1;
  char_expected_dtm->descriptor_->is_default_label = 0;
  XTypes::DynamicTypeMember_rch short_expected_dtm = DCPS::make_rch<XTypes::DynamicTypeMember>();
  short_expected_dtm->descriptor_->name = "s";
  short_expected_dtm->descriptor_->id = 2;
  short_expected_dtm->descriptor_->index = 2;
  ...
  second_expected_dtm->descriptor_->index = 1;
  second_expected_dtm->descriptor_->try_construct_kind = XTypes::DISCARD;
  first_expected_dtm->descriptor_->type = expected_enum_dt;
  second_expected_dtm->descriptor_->type = expected_enum_dt;
  long_expected_dtm->descriptor_->type = long_expected_dt;
  char_expected_dtm->descriptor_->type = char_expected_dt;
  short_expected_dtm->descriptor_->type = short_expected_dt;
...
TEST(CompleteToDynamicType, MyAnonStruct)
{
  ...
  sequence_dtm->descriptor_->name = "lseq";
  sequence_dtm->descriptor_->id = 0;
  sequence_dtm->descriptor_->index = 0;
  sequence_dtm->descriptor_->try_construct_kind = XTypes::DISCARD;
  XTypes::DynamicTypeMember_rch array_dtm = DCPS::make_rch<XTypes::DynamicTypeMember>();
  array_dtm->descriptor_->name = "larr";
  array_dtm->descriptor_->id = 1;
  ...
  sequence_dtm->descriptor_->type = sequence_expected_dt;
  array_dtm->descriptor_->type = array_expected_dt;
...
TEST(CompleteToDynamicType, CircularStruct)
{
  ...
  struct_seq_dtm->descriptor_->name = "circular_struct2_seq";
  struct_seq_dtm->descriptor_->id = 0;
  ...
  struct2_seq_dtm->descriptor_->name = "circular_struct_seq";
  struct2_seq_dtm->descriptor_->id = 0;
  ...
  struct2_seq_dtm->descriptor_->type = struct2_seq_dt;
  struct2_seq_td->element_type = struct_expected_dt;

  struct_seq_dtm->descriptor_->type = struct_seq_dt;
