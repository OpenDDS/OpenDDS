...
public:
  ...
  ACE_Message_Block* serialize_sample(Test::SimpleDataWriterImpl* dw,
                                      ...
                                      Sample::Extent extent = Sample::Full)
  {
    const Test::SimpleDataWriterImpl::SampleType sample(instance_data, extent);
  ...
  Test::SimpleTypeSupportImpl ts_;
};
  ...
  try {
    ...
    try { // the real testing.
      ...
      { //Test Case 1 scope
        ...
        Message_Block_Ptr mb(test->serialize_sample(fast_dw.get(), foo1, Sample::KeyOnly));
        ...
        Message_Block_Ptr mb1(test->serialize_sample(fast_dw.get(), foo1, Sample::KeyOnly));
      ...
      { //Test Case 2 scope
        ...
        Message_Block_Ptr mb2(test->serialize_sample(fast_dw.get(), foo2, Sample::KeyOnly));
        ...
        Message_Block_Ptr mb3(test->serialize_sample(fast_dw.get(), foo3, Sample::KeyOnly));
