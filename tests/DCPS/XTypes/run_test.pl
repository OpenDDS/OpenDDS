...
if ($type_consistency) {
  %type_consistency_params = (
    ...
    "DisallowTypeCoercion_AppendableStructNoMatch2" => {reader_type => "AppendableStruct", writer_type => "AdditionalPrefixFieldStruct",
                                                        ...
                                                        r_ini => "rtps_disc.ini", w_ini => "rtps_disc.ini",
                                                        reader_args => "--disallow_type_coercion"},
    "DisallowTypeCoercion_MutableStructNoMatch" => {reader_type => "MutableStruct", writer_type => "ModifiedMutableStruct",
                                                    expect_to_fail => 1, topic => "MutableStructNoMatch_DTC", key_val => 1,
                                                    r_ini => "rtps_disc.ini", w_ini => "rtps_disc.ini",
                                                    reader_args => "--disallow_type_coercion"},
