...
PubDriver::listener_test ()
{
  ...
  TEST_CHECK (ret == ::DDS::RETCODE_OK
              ...
              && subscription_handles[0] == OpenDDS::DCPS::RepoIdConverter(sub_id_).checksum());
  ...
  TEST_CHECK (match_status.last_subscription_handle == OpenDDS::DCPS::RepoIdConverter(sub_id_).checksum());
