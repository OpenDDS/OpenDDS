...
{
  try {
    OpenDDS::Monitor::DataReaderPeriodicReportDataReader_var drperm_dr =
      OpenDDS::Monitor::DataReaderPeriodicReportDataReader::_narrow(reader);
    ...
    OpenDDS::Monitor::DataReaderPeriodicReport drperr;
    DDS::SampleInfo si;
