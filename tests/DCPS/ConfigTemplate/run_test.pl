...
sub runTest {
    ...
    $test->process("alpha", 'ConfigTemplateTest', "-DCPSConfigFile config.ini -DCPSDebugLevel $dcps_debug_lvl -origin $origin -reliable $reliable -dw_static_disc 0 -dr_static_disc 0 -wdomain 12 -rdomain 31 -writer 000012 -reader 000013");
    ...
    $origin = 0;
    $test->process("beta", 'ConfigTemplateTest', "-DCPSConfigFile config.ini -DCPSDebugLevel $dcps_debug_lvl -origin $origin -reliable $reliable -dw_static_disc $dw_static -dr_static_disc 0 -wdomain 23 -rdomain 12 -dw_participant 000000000023 -writer 000023 -reader 000021");
    ...
    $test->process("gamma", 'ConfigTemplateTest', "-DCPSConfigFile config.ini -DCPSDebugLevel $dcps_debug_lvl -origin $origin -reliable $reliable -dw_static_disc 0 -dr_static_disc $dr_static -wdomain 31 -rdomain 23 -dr_participant 000000000032 -writer 000031 -reader 000032");
