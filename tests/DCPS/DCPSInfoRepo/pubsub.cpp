...
bool pubsub(OpenDDS::DCPS::Discovery_rch disc, CORBA::ORB_var orb)
{
  ...
  OpenDDS::DCPS::RcHandle<TAO_DDS_DCPSDataWriter_i> dwImpl(new TAO_DDS_DCPSDataWriter_i, OpenDDS::DCPS::keep_count());
  ...
  try
    {
      ...
      if (use_rtps) {
        OpenDDS::RTPS::RtpsDiscovery_rch rtpsDisc(new OpenDDS::RTPS::RtpsDiscovery("TestRtpsDiscovery"), OpenDDS::DCPS::keep_count());
        ...
        OpenDDS::DCPS::RcHandle<OpenDDS::DCPS::InfoRepoDiscovery> ird(
          new OpenDDS::DCPS::InfoRepoDiscovery("TestInfoRepoDiscovery", info), OpenDDS::DCPS::keep_count());
