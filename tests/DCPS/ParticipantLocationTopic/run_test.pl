...
$test->process("publisher", "publisher", "-ORBDebugLevel 1 -DCPSConfigFile". $pub_sub_ini);
$test->process("subscriber", "subscriber", "-ORBDebugLevel 1 -DCPSConfigFile" . $pub_sub_ini);
