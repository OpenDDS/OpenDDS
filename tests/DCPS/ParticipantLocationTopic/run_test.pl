...
$test->process("publisher", "publisher", $ice_arg . "-ORBDebugLevel 1 -DCPSConfigFile". $pub_sub_ini);
$test->process("subscriber", "subscriber", $ice_arg . "-ORBDebugLevel 1 -DCPSConfigFile" . $pub_sub_ini);
