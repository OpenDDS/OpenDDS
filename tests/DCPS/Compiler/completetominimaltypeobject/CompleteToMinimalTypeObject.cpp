...
TEST(CompleteToMinimalTypeObject, Struct)
{
  ...
  ::DDS::DataWriter_var dw =
    pub->create_datawriter(my_topic.in (),
                            ...
                            ::OpenDDS::DCPS::DEFAULT_STATUS_MASK);
  OpenDDS::XTypes::TypeMap ctm = stru_tsi.getCompleteTypeMap();
  OpenDDS::XTypes::TypeObject cto = ctm[OpenDDS::XTypes::TypeIdentifier(OpenDDS::XTypes::EK_COMPLETE,
    OpenDDS::XTypes::EquivalenceHashWrapper(168, 72, 172, 8, 184, 103, 37, 100, 24, 24, 29, 129, 165, 47))];
  OpenDDS::XTypes::TypeMap mtm = stru_tsi.getMinimalTypeMap();
  OpenDDS::XTypes::TypeObject c_to_m_mto;
  if (!tls->complete_to_minimal_typeobject(cto, c_to_m_mto)) {
    ASSERT_EQ(1,0);
  }
  OpenDDS::XTypes::TypeObject mto2 = mtm[OpenDDS::XTypes::TypeIdentifier(OpenDDS::XTypes::EK_MINIMAL,
    OpenDDS::XTypes::EquivalenceHashWrapper(189, 72, 116, 15, 57, 244, 144, 185, 189, 193, 70, 196, 210, 42))];
...
TEST(CompleteToMinimalTypeObject, Union)
{
  ...
  ::DDS::DataWriter_var dw =
    pub->create_datawriter(my_topic.in (),
                            ...
                            ::DDS::DataWriterListener::_nil(),
                            ::OpenDDS::DCPS::DEFAULT_STATUS_MASK);
  OpenDDS::XTypes::TypeMap ctm = uts.getCompleteTypeMap();
  OpenDDS::XTypes::TypeObject cto = ctm[OpenDDS::XTypes::TypeIdentifier(OpenDDS::XTypes::EK_COMPLETE,
    OpenDDS::XTypes::EquivalenceHashWrapper(70, 184, 188, 58, 218, 154, 35, 224, 117, 149, 213, 242, 180, 239))];
  OpenDDS::XTypes::TypeObject c_to_m_mto;
  if (!tls->complete_to_minimal_typeobject(cto, c_to_m_mto)) {
    ASSERT_EQ(1,0);
  }
  OpenDDS::XTypes::TypeMap mtm = uts.getMinimalTypeMap();
  OpenDDS::XTypes::TypeObject mto2 = mtm[OpenDDS::XTypes::TypeIdentifier(OpenDDS::XTypes::EK_MINIMAL,
    OpenDDS::XTypes::EquivalenceHashWrapper(94, 42, 84, 196, 20, 69, 255, 70, 95, 183, 166, 22, 4, 142))];
  ASSERT_EQ(mto2, c_to_m_mto);
}
...
TEST(CompleteToMinimalTypeObject, Sequence)
{
  ...
  ::DDS::DataWriter_var dw =
    pub->create_datawriter(my_topic.in (),
                            ...
                            ::OpenDDS::DCPS::DEFAULT_STATUS_MASK);
  OpenDDS::XTypes::TypeMap ctm = stru_tsi.getCompleteTypeMap();
  OpenDDS::XTypes::TypeObject cto = ctm[OpenDDS::XTypes::TypeIdentifier(OpenDDS::XTypes::TI_STRONGLY_CONNECTED_COMPONENT,
    OpenDDS::XTypes::StronglyConnectedComponentId(OpenDDS::XTypes::TypeObjectHashId(OpenDDS::XTypes::EK_COMPLETE,
    OpenDDS::XTypes::EquivalenceHashWrapper(42, 203, 214, 182, 80, 84, 4, 33, 118, 109, 127, 170, 57, 95)), 5, 2))];
  OpenDDS::XTypes::TypeMap mtm = stru_tsi.getMinimalTypeMap();
  OpenDDS::XTypes::TypeObject c_to_m_mto;
  if (!tls->complete_to_minimal_typeobject(cto, c_to_m_mto)) {
    ASSERT_EQ(1,0);
  }
  OpenDDS::XTypes::TypeObject mto2 = mtm[OpenDDS::XTypes::TypeIdentifier(OpenDDS::XTypes::TI_STRONGLY_CONNECTED_COMPONENT,
    OpenDDS::XTypes::StronglyConnectedComponentId(OpenDDS::XTypes::TypeObjectHashId(OpenDDS::XTypes::EK_MINIMAL,
    OpenDDS::XTypes::EquivalenceHashWrapper(23, 96, 109, 112, 215, 248, 161, 152, 79, 50, 37, 116, 6, 230)), 5, 2))];
  ASSERT_EQ(mto2, c_to_m_mto);
}
...
TEST(CompleteToMinimalTypeObject, Array)
{
  ...
  ::DDS::DataWriter_var dw =
    pub->create_datawriter(my_topic.in (),
                            ...
                            ::DDS::DataWriterListener::_nil(),
                            ::OpenDDS::DCPS::DEFAULT_STATUS_MASK);
  OpenDDS::XTypes::TypeMap ctm = un_tsi.getCompleteTypeMap();
  OpenDDS::XTypes::TypeObject cto = ctm[OpenDDS::XTypes::TypeIdentifier(OpenDDS::XTypes::TI_STRONGLY_CONNECTED_COMPONENT,
    OpenDDS::XTypes::StronglyConnectedComponentId(OpenDDS::XTypes::TypeObjectHashId(OpenDDS::XTypes::EK_COMPLETE,
    OpenDDS::XTypes::EquivalenceHashWrapper(42, 203, 214, 182, 80, 84, 4, 33, 118, 109, 127, 170, 57, 95)), 5, 1))];
  OpenDDS::XTypes::TypeMap mtm = un_tsi.getMinimalTypeMap();
  OpenDDS::XTypes::TypeObject c_to_m_mto;
  if (!tls->complete_to_minimal_typeobject(cto, c_to_m_mto)) {
    ASSERT_EQ(1,0);
  }
  OpenDDS::XTypes::TypeObject mto2 = mtm[OpenDDS::XTypes::TypeIdentifier(OpenDDS::XTypes::TI_STRONGLY_CONNECTED_COMPONENT,
    OpenDDS::XTypes::StronglyConnectedComponentId(OpenDDS::XTypes::TypeObjectHashId(OpenDDS::XTypes::EK_MINIMAL,
    OpenDDS::XTypes::EquivalenceHashWrapper(23, 96, 109, 112, 215, 248, 161, 152, 79, 50, 37, 116, 6, 230)), 5, 1))];
  ASSERT_EQ(mto2, c_to_m_mto);
}
...
TEST(CompleteToMinimalTypeObject, AliasSequence)
{
  ...
  OpenDDS::XTypes::TypeMap ctm = un_tsi.getCompleteTypeMap();
  OpenDDS::XTypes::TypeObject cto = ctm[OpenDDS::XTypes::TypeIdentifier(OpenDDS::XTypes::EK_COMPLETE,
    OpenDDS::XTypes::EquivalenceHashWrapper(191, 174, 166, 236, 84, 2, 202, 95, 146, 223, 113, 33, 94, 89))];
  OpenDDS::XTypes::TypeMap mtm = un_tsi.getMinimalTypeMap();
  OpenDDS::XTypes::TypeObject c_to_m_mto;
  if (!tls->complete_to_minimal_typeobject(cto, c_to_m_mto)) {
    ASSERT_EQ(1,0);
  ...
  OpenDDS::XTypes::TypeObject mto2 = mtm[OpenDDS::XTypes::TypeIdentifier(OpenDDS::XTypes::EK_MINIMAL,
    OpenDDS::XTypes::EquivalenceHashWrapper(64, 132, 84, 128, 187, 1, 123, 173, 187, 231, 55, 190, 22, 206))];
  ASSERT_EQ(mto2, c_to_m_mto);
}
...
TEST(CompleteToMinimalTypeObject, AliasArray)
{
  ...
  OpenDDS::XTypes::TypeMap ctm = un_tsi.getCompleteTypeMap();
  OpenDDS::XTypes::TypeObject cto = ctm[OpenDDS::XTypes::TypeIdentifier(OpenDDS::XTypes::EK_COMPLETE,
    OpenDDS::XTypes::EquivalenceHashWrapper(80, 3, 53, 153, 247, 134, 18, 76, 42, 156, 63, 245, 137, 180))];
  OpenDDS::XTypes::TypeMap mtm = un_tsi.getMinimalTypeMap();
  OpenDDS::XTypes::TypeObject c_to_m_mto;
  if (!tls->complete_to_minimal_typeobject(cto, c_to_m_mto)) {
    ASSERT_EQ(1,0);
  ...
  OpenDDS::XTypes::TypeObject mto2 = mtm[OpenDDS::XTypes::TypeIdentifier(OpenDDS::XTypes::EK_MINIMAL,
    OpenDDS::XTypes::EquivalenceHashWrapper(115, 7, 58, 161, 22, 145, 40, 98, 164, 53, 75, 57, 105, 170))];
  ASSERT_EQ(mto2, c_to_m_mto);
}
...
TEST(CompleteToMinimalTypeObject, Enumerated)
{
  ...
  OpenDDS::XTypes::TypeMap ctm = un_tsi.getCompleteTypeMap();
  OpenDDS::XTypes::TypeObject cto = ctm[OpenDDS::XTypes::TypeIdentifier(OpenDDS::XTypes::EK_COMPLETE,
    OpenDDS::XTypes::EquivalenceHashWrapper(208, 102, 40, 140, 43, 232, 192, 255, 146, 120, 236, 77, 165, 0))];
  OpenDDS::XTypes::TypeMap mtm = un_tsi.getMinimalTypeMap();
  OpenDDS::XTypes::TypeObject c_to_m_mto;
  if (!tls->complete_to_minimal_typeobject(cto, c_to_m_mto)) {
    ASSERT_EQ(1,0);
  ...
  OpenDDS::XTypes::TypeObject mto2 = mtm[OpenDDS::XTypes::TypeIdentifier(OpenDDS::XTypes::EK_MINIMAL,
    OpenDDS::XTypes::EquivalenceHashWrapper(197, 93, 228, 89, 233, 88, 151, 207, 208, 98, 147, 32, 200, 147))];
  ASSERT_EQ(mto2, c_to_m_mto);
}
