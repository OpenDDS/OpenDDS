...
my $node_1_opts = "$opts -n node_1 -d files1 -DCPSInfoRepo corbaloc:iiop:127.0.0.1:$dcpsrepo_port/DCPSInfoRepo ";
my $node_2_opts = "$opts -n node_2 -d files2 -DCPSInfoRepo corbaloc:iiop:127.0.0.1:$dcpsrepo_port/DCPSInfoRepo";
my $node_3_opts = "$opts -n node_3 -d files3 -f starter.bin -DCPSInfoRepo corbaloc:iiop:127.0.0.1:$dcpsrepo_port/DCPSInfoRepo";
