...
.. option:: -Gtypeobject
  ...
  Generate XTypes Type Objects.  This option is only useful along with -Sdefault because Type Objects are generated by default.

.. option: --append-typeobjects FILE

  Open FILE in append mode and write Type Objects (as byte arrays) to the file.  This is in addition to normal code generation.
