...
int ACE_TMAIN(int argc, ACE_TCHAR* argv[])
{
  ...
  known-scenario-names.insert("echo-tcp");
  known-scenario-names.insert("echo-rtps");
  known-scenario-names.insert("fan-tcp");
  known-scenario-names.insert("fan-rtps");
  known-scenario-names.insert("showtime-mixed");
  known-scenario-names.insert("b1-latency-raw-tcp");
  known-scenario-names.insert("b1-latency-raw-udp");
  known-scenario-names.insert("b1-latency-tcp");
  known-scenario-names.insert("b1-latency-udp");
  known-scenario-names.insert("b1-latency-multicast-be");
  known-scenario-names.insert("b1-latency-multicast-rel");
  known-scenario-names.insert("b1-latency-rtps");
