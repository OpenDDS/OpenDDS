...
$Pub3 = PerlDDS::create_process ("publisher", $pub_parameters . " -i $pub_writer_id -a $pub_addr_host:$pub_addr_port");
print $Pub3->CommandLine(), "\n";
$pub_addr_port++;
$pub_writer_id++;

$Pub4 = PerlDDS::create_process ("publisher", $pub_parameters . " -i $pub_writer_id -a $pub_addr_host:$pub_addr_port");
