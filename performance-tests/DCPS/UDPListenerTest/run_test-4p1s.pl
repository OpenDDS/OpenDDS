...
$Pub2 = new PerlACE::Process ("publisher", $pub_parameters . " $app_bit_conf -i $pub_writer_id -a $pub_addr_host:$pub_addr_port");
print $Pub2->CommandLine(), "\n";
$pub_addr_port++;
$pub_writer_id++;

$Pub3 = new PerlACE::Process ("publisher", $pub_parameters . " $app_bit_conf -i $pub_writer_id -a $pub_addr_host:$pub_addr_port");
print $Pub3->CommandLine(), "\n";
$pub_addr_port++;
$pub_writer_id++;

$Pub4 = new PerlACE::Process ("publisher", $pub_parameters . " $app_bit_conf -i $pub_writer_id -a $pub_addr_host:$pub_addr_port");
