...
ActionManager::ActionManager(const Stool::ActionConfigSeq& configs, Stool::ActionReportSeq& reports, Builder::ReaderMap& reader_map, Builder::WriterMap& writer_map) {
