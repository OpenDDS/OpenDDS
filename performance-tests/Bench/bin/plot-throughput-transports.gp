...
plot capacity with lines t 'Network Capacity',\
     ...
     ''             index 0 using 1:3:(0.1) with lines $2 t 'TCP Bidir: rate & size vary',\
     ''             index 1 using 1:3:(0.1) with lines $2 t 'TCP Bidir: rate 1,000',\
     ''             index 2 using 2:3:(0.1) with lines $2 axes x2y1 t 'TCP Bidir: size 10,000',\
     ''             index 9 using 1:3:(0.1) with lines $2 t 'UDP Bidir: rate & size vary',\
     ''             index 10 using 1:3:(0.1) with lines $2 t 'UDP Bidir: rate 1,000',\
     ''             index 11 using 2:3:(0.1) with lines $2 axes x2y1 t 'UDP Bidir: size 10,000',\
     ''             index 3 using 1:3:(0.1) with lines $2 t 'MC Be Bidir: rate & size vary',\
     ''             index 4 using 1:3:(0.1) with lines $2 t 'MC Be Bidir: rate 1,000',\
     ''             index 5 using 2:3:(0.1) with lines $2 axes x2y1 t 'MC Be Bidir: size 10,000',\
     ''             index 6 using 1:3:(0.1) with lines $2 t 'MC Rel Bidir: rate & size vary',\
     ''             index 7 using 1:3:(0.1) with lines $2 t 'MC Rel Bidir: rate 1,000',\
     ''             index 8 using 2:3:(0.1) with lines $2 axes x2y1 t 'MC Rel Bidir: size 10,000'
...
plot capacity with lines t 'Network Capacity',\
     ...
     ''             index 8 using 1:3 with points t 'data points:',\
