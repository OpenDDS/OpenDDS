...
#include "org_opendds_DCPSInfoRepo.h"
...
#define DCPSInfoRepo_init \
  Java_org_opendds_DCPSInfoRepo_init

#define DCPSInfoRepo_fini \
  Java_org_opendds_DCPSInfoRepo_fini

#define DCPSInfoRepo_run \
  Java_org_opendds_DCPSInfoRepo_run

#define DCPSInfoRepo_shutdown \
  Java_org_opendds_DCPSInfoRepo_shutdown
