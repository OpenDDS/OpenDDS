...
idl2jni_visitor::~idl2jni_visitor (void)
{
}
...
idl2jni_visitor::visit_module (AST_Module *node)
{
  ...
  BE_Comment_Guard g ("MODULE", name); ACE_UNUSED_ARG (g);
...
idl2jni_visitor::visit_interface (AST_Interface *node)
{
  ...
  const char *name = node->local_name ()->get_string ();
  BE_Comment_Guard g ("INTERFACE", name); ACE_UNUSED_ARG (g);
  addToToplevels (node);
...
idl2jni_visitor::visit_structure (AST_Structure *node)
{
  ...
  const char *name = node->local_name ()->get_string ();
  BE_Comment_Guard g ("STRUCT", name); ACE_UNUSED_ARG (g);
  addToToplevels (node);
...
idl2jni_visitor::visit_exception (AST_Exception *node)
{
  ...
  const char *name = node->local_name ()->get_string ();
  BE_Comment_Guard g ("EXCEPTION", name); ACE_UNUSED_ARG (g);
  addToToplevels (node);
...
idl2jni_visitor::visit_typedef (AST_Typedef *node)
{
  ...
  const char *name = node->local_name ()->get_string ();
  BE_Comment_Guard g ("TYPEDEF", name); ACE_UNUSED_ARG (g);
  addToToplevels (node);
...
idl2jni_visitor::visit_enum (AST_Enum *node)
{
  ...
  const char *name = node->local_name ()->get_string ();
  BE_Comment_Guard g ("ENUM", name); ACE_UNUSED_ARG (g);
  addToToplevels (node);
...
{
  const char *name = node->local_name ()->get_string ();
  BE_Comment_Guard g ("INTERFACE-FWD", name); ACE_UNUSED_ARG (g);
...
idl2jni_visitor::visit_constant (AST_Constant *node)
{
  ...
  const char *name = node->local_name ()->get_string ();
  BE_Comment_Guard g ("CONST", name); ACE_UNUSED_ARG (g);
  addToToplevels (node);
...
idl2jni_visitor::visit_native (AST_Native *node)
{
  ...
  const char *name = node->local_name ()->get_string ();
  BE_Comment_Guard g ("NATIVE", name); ACE_UNUSED_ARG (g);
...
idl2jni_visitor::visit_union (AST_Union *node)
{
  ...
  const char *name = node->local_name ()->get_string ();
  BE_Comment_Guard g ("UNION", name); ACE_UNUSED_ARG (g);
  addToToplevels (node);
