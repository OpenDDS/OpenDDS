    ...
    case AST_Decl::NT_pre_defined:
      {
        ...
        switch (p->pt ())
          {
          case AST_PredefinedType::PT_boolean:    return "CORBA::Boolean";
          case AST_PredefinedType::PT_char:       return "CORBA::Char";
          case AST_PredefinedType::PT_wchar:      return "CORBA::WChar";
          case AST_PredefinedType::PT_octet:      return "CORBA::Octet";
          case AST_PredefinedType::PT_short:      return "CORBA::Short";
          case AST_PredefinedType::PT_ushort:     return "CORBA::UShort";
          case AST_PredefinedType::PT_long:       return "CORBA::Long";
          case AST_PredefinedType::PT_ulong:      return "CORBA::ULong";
          case AST_PredefinedType::PT_longlong:   return "CORBA::LongLong";
          case AST_PredefinedType::PT_ulonglong:  return "CORBA::ULongLong";
          case AST_PredefinedType::PT_float:      return "CORBA::Float";
          case AST_PredefinedType::PT_double:     return "CORBA::Double";
          default: ;
          }
      }
    case AST_Decl::NT_string:     return "CORBA::String_var";
    case AST_Decl::NT_enum:       return scoped (decl->name ());
    case AST_Decl::NT_interface:  return scoped (decl->name ()) + "_var";
    default: ;
    }
  ...
  switch (effectiveType)
    ...
    case AST_Decl::NT_interface:
      if (dir == AST_Argument::dir_OUT)
        ...
        param = name + "_ptr";
      //fall-through
    case AST_Decl::NT_pre_defined:  addConst = false; break;
    case AST_Decl::NT_string:       param = "char *"; break;
    case AST_Decl::NT_wstring:      param = "CORBA::WChar *"; break;
...
string idl_mapping_jni::type (AST_Type *decl)
{
  switch (decl->node_type ())
    ...
    case AST_Decl::NT_pre_defined:
      {
        ...
        switch (p->pt ())
          {
          case AST_PredefinedType::PT_boolean:    return "jboolean";
          case AST_PredefinedType::PT_char:
          case AST_PredefinedType::PT_wchar:      return "jchar";
          case AST_PredefinedType::PT_octet:      return "jbyte";
          case AST_PredefinedType::PT_short:
          case AST_PredefinedType::PT_ushort:     return "jshort";
          case AST_PredefinedType::PT_long:
          case AST_PredefinedType::PT_ulong:      return "jint";
          case AST_PredefinedType::PT_longlong:
          case AST_PredefinedType::PT_ulonglong:  return "jlong";
          case AST_PredefinedType::PT_float:      return "jfloat";
          case AST_PredefinedType::PT_double:     return "jdouble";
          default:                                return "jobject";
          }
      }
    case AST_Decl::NT_string:
    case AST_Decl::NT_enum:
    case AST_Decl::NT_struct:                     return "jobject";
    ...
    case AST_Decl::NT_native:                     return "jobjectArray";
    default:                                      return "jobject";
    }
}
    ...
    case AST_Decl::NT_pre_defined:
      {
        ...
        switch (p->pt ())
          {
          case AST_PredefinedType::PT_boolean:    return "Z";
          case AST_PredefinedType::PT_char:
          case AST_PredefinedType::PT_wchar:      return "C";
          case AST_PredefinedType::PT_octet:      return "B";
          case AST_PredefinedType::PT_short:
          case AST_PredefinedType::PT_ushort:     return "S";
          case AST_PredefinedType::PT_long:
          case AST_PredefinedType::PT_ulong:      return "I";
          case AST_PredefinedType::PT_longlong:
          case AST_PredefinedType::PT_ulonglong:  return "J";
          case AST_PredefinedType::PT_float:      return "F";
          case AST_PredefinedType::PT_double:     return "D";
          default:                                ;//fall through
          }
      }
    case AST_Decl::NT_string: return "Ljava/lang/String;";
    case AST_Decl::NT_enum:
    case AST_Decl::NT_struct:
    case AST_Decl::NT_union:
    case AST_Decl::NT_interface:
...
string idl_mapping_jni::jniFnName (AST_Type *decl)
{
  switch (decl->node_type ())
    ...
    case AST_Decl::NT_pre_defined:
      {
        ...
        switch (p->pt ())
          ...
          case AST_PredefinedType::PT_char:
          case AST_PredefinedType::PT_wchar:      return "Char";
          case AST_PredefinedType::PT_octet:      return "Byte";
          case AST_PredefinedType::PT_short:
          case AST_PredefinedType::PT_ushort:     return "Short";
          case AST_PredefinedType::PT_long:
          case AST_PredefinedType::PT_ulong:      return "Int";
          case AST_PredefinedType::PT_longlong:
          case AST_PredefinedType::PT_ulonglong:  return "Long";
    ...
    case AST_Decl::NT_string:
    case AST_Decl::NT_enum:
    case AST_Decl::NT_struct:                     return "Object";
    case AST_Decl::NT_typedef:
      {
        AST_Typedef *td = AST_Typedef::narrow_from_decl (decl);
...
namespace
{
  ...
  bool isSSU (AST_Type *t) //sequence, struct, union
  {
    ...
    switch (t->node_type ())
      ...
      case AST_Decl::NT_sequence:
      case AST_Decl::NT_struct:
      case AST_Decl::NT_union:    return true;
...
namespace
{
  ostream &operator<< (ostream &o, AST_Expression::AST_ExprValue *ev)
  {
    switch (ev->et)
      {
      case AST_Expression::EV_short:      o << ev->u.sval; break;
      case AST_Expression::EV_ushort:     o << ev->u.usval; break;
      case AST_Expression::EV_long:       o << ev->u.lval; break;
      case AST_Expression::EV_ulong:      o << ev->u.ulval; break;
      case AST_Expression::EV_longlong:   o << ev->u.llval << "LL"; break;
      case AST_Expression::EV_ulonglong:  o << ev->u.ullval << "ULL"; break;
      case AST_Expression::EV_float:      o << ev->u.fval << 'F'; break;
