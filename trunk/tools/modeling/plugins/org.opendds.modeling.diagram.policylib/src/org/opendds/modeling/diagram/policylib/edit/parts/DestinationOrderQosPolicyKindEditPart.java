 ...
 * @generated
 */
public class DestinationOrderQosPolicyKindEditPart extends CompartmentEditPart
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.DIRECT_EDIT_ROLE,
				new EnumDirectEditPolicy(DestinationOrderQosPolicyKind.class));
	...
	public IParser getParser() {
		if (parser == null) {
			parser = OpenDDSPolicyLibParserProvider
					.getParser(
							OpenDDSPolicyLibElementTypes.DestinationOrderQosPolicy_2022,
							getParserElement(),
							OpenDDSPolicyLibVisualIDRegistry
									.getType(org.opendds.modeling.diagram.policylib.edit.parts.DestinationOrderQosPolicyKindEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new EnumDirectEditManager(this,
					EnumDirectEditManager.getCellEditorClass(),
