...
import org.opendds.modeling.diagram.dcpslib.edit.parts.Period9EditPart;
import org.opendds.modeling.diagram.dcpslib.edit.parts.TbfQosPolicyMinimum_separation2EditPart;
 ...
 * @generated
 */
public class TbfQosPolicy2ItemSemanticEditPolicy extends
		OpenDDSDcpsLibBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public TbfQosPolicy2ItemSemanticEditPolicy() {
		super(OpenDDSDcpsLibElementTypes.TbfQosPolicy_3053);
	}
	...
	private void addDestroyChildNodesCommand(ICompositeCommand cmd) {
		...
		for (Iterator nit = view.getChildren().iterator(); nit.hasNext();) {
			...
			case TbfQosPolicyMinimum_separation2EditPart.VISUAL_ID:
				for (Iterator cit = node.getChildren().iterator(); cit
					...
					case Period9EditPart.VISUAL_ID:
