...
Systems powered by DDS run the world's most complex systems. This complimentary, half-day, [free public event](https://www.omg.org/events/va-20/special-events/DDS.htm) will provide an overview of the latest advancements in the [DDS standard](https://www.omg.org/spec/DDS), case studies from end users, and a panel discussion of experts. Hosted by the [DDS Foundation](https://dds-foundation.org), this is a dynamic, informative, and interactive event for those using DDS, or those who are exploring technologies needed to develop and run their next-generation systems.
