	...
	public IParser getParser() {
		if (parser == null) {
			parser = OpenDDSPolicyLibraryParserProvider
					.getParser(
							OpenDDSPolicyLibraryElementTypes.LivelinessQosPolicy_2030,
							getParserElement(),
							OpenDDSPolicyLibraryVisualIDRegistry
									.getType(org.opendds.modeling.model.opendds.diagram.policylibrary.edit.parts.LivelinessQosPolicyKindEditPart.VISUAL_ID));
		}
		return parser;
	}
