	...
	public IParser getParser() {
		if (parser == null) {
			parser = OpenDDSPolicyLibraryParserProvider
					.getParser(
							OpenDDSPolicyLibraryElementTypes.HistoryQosPolicy_2027,
							getParserElement(),
							OpenDDSPolicyLibraryVisualIDRegistry
									.getType(org.opendds.modeling.model.opendds.diagram.policylibrary.edit.parts.HistoryQosPolicyKindEditPart.VISUAL_ID));
		}
		return parser;
	}
