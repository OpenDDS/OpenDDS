...
import org.opendds.modeling.model.opendds.diagram.dcpslib.part.QosPolicyClassNameToRefName;

/**
 * A GMF command to add a reference to a Feature-derived class.
 ...
 * @generated NOT
 */
public class QosPolicyReferCommand extends EditElementCommand {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		String refName = QosPolicyClassNameToRefName.getRefName(newElementClassName);
	...
	/**
	 * Based on GMF 2.2.2 generated code take from FeatureACreateCommand.
	 * If generated code changes then this would have to similarly change.
	 *  @see FeatureACreateCommand.getElementToEdit()
	 */
	@Override
	 ...
	 * Based on GMF 2.2.2 generated code take from FeatureACreateCommand.
	 * If generated code changes then this would have to similarly change.
	 *  @see FeatureACreateCommand.doConfigure()
	 */
