...
public class OpenDDSActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener {
    ...
    public void contributeToToolBar(IToolBarManager toolBarManager) {
        toolBarManager.add(new Separator("opendds-settings"));
        toolBarManager.add(new Separator("opendds-additions"));
    }
    ...
    public void contributeToMenu(IMenuManager menuManager) {
        ...
        IMenuManager submenuManager = new MenuManager(EditorPlugin.INSTANCE.getString("_UI_OpenDDSEditor_menu"),
                "OpenDDSMenuID");
