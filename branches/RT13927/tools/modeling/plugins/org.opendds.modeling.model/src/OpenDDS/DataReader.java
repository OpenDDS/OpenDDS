 ...
 * <li>{@link OpenDDS.DataReader#getReader_data_lifecycle <em>Reader
 * data lifecycle</em>}</li>
 * <li>{@link OpenDDS.DataReader#getTransport_priority <em>Transport
 * priority</em>}</li>
 * <li>{@link OpenDDS.DataReader#getDurability_service <em>Durability
 * service</em>}</li>
 * <li>{@link OpenDDS.DataReader#getOwnership_strength <em>Ownership
 * strength</em>}</li>
 * </ul>
 * </p>
 * 
...
public interface DataReader extends DataReaderWriter {
    ...
    /**
     * Sets the value of the '{@link OpenDDS.DataReader#getTopic
    ...
    /**
     * Returns the value of the '<em><b>Reader data lifecycle</b></em>
     ...
     * <!-- end-user-doc -->
     * 
     * @return the value of the '<em>Reader data lifecycle</em>'
     *         reference.
     ...
     * 
     * @param value
     *            the new value of the '<em>Reader data lifecycle</em>
     *            ' reference.
    ...
    /**
     * Returns the value of the '<em><b>Ownership strength</b></em>'
     * reference. <!-- begin-user-doc -->
     * <p>
     ...
     * <!-- end-user-doc -->
     * 
     * @return the value of the '<em>Ownership strength</em>'
     *         reference.
     ...
     * 
     * @param value
     *            the new value of the '<em>Ownership strength</em>'
     *            reference.
