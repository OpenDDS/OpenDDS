...
public class DurabilityServiceQosPolicyItemProvider extends QosPolicyItemProvider implements
    ...
    protected void addHistory_depthPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                ...
                getString("_UI_DurabilityServiceQosPolicy_history_depth_feature"), getString(
                        "_UI_PropertyDescriptor_description", "_UI_DurabilityServiceQosPolicy_history_depth_feature",
                        "_UI_DurabilityServiceQosPolicy_type"),
                OpenDDSPackage.Literals.DURABILITY_SERVICE_QOS_POLICY__HISTORY_DEPTH, true, false, false,
    ...
    protected void addHistory_kindPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                .getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_DurabilityServiceQosPolicy_history_kind_feature"), getString(
                        "_UI_PropertyDescriptor_description", "_UI_DurabilityServiceQosPolicy_history_kind_feature",
                        "_UI_DurabilityServiceQosPolicy_type"),
                OpenDDSPackage.Literals.DURABILITY_SERVICE_QOS_POLICY__HISTORY_KIND, true, false, false,
    ...
    protected void addMax_instancesPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                .getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_DurabilityServiceQosPolicy_max_instances_feature"), getString(
                        "_UI_PropertyDescriptor_description", "_UI_DurabilityServiceQosPolicy_max_instances_feature",
                        "_UI_DurabilityServiceQosPolicy_type"),
                OpenDDSPackage.Literals.DURABILITY_SERVICE_QOS_POLICY__MAX_INSTANCES, true, false, false,
                ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
    }
    ...
    protected void addMax_samplesPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                .getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_DurabilityServiceQosPolicy_max_samples_feature"), getString(
                        "_UI_PropertyDescriptor_description", "_UI_DurabilityServiceQosPolicy_max_samples_feature",
                        "_UI_DurabilityServiceQosPolicy_type"),
                OpenDDSPackage.Literals.DURABILITY_SERVICE_QOS_POLICY__MAX_SAMPLES, true, false, false,
                ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
    }
    ...
    protected void addMax_samples_per_instancePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                .getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_DurabilityServiceQosPolicy_max_samples_per_instance_feature"), getString(
                        "_UI_PropertyDescriptor_description",
                        "_UI_DurabilityServiceQosPolicy_max_samples_per_instance_feature",
                        "_UI_DurabilityServiceQosPolicy_type"),
                OpenDDSPackage.Literals.DURABILITY_SERVICE_QOS_POLICY__MAX_SAMPLES_PER_INSTANCE, true, false, false,
                ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
    }
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(OpenDDSPackage.Literals.DURABILITY_SERVICE_QOS_POLICY__SERVICE_CLEANUP_DELAY);
        }
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/DurabilityServiceQosPolicy"));
    }
    ...
    public String getText(Object object) {
        ...
        return getString("_UI_DurabilityServiceQosPolicy_type") + " " + durabilityServiceQosPolicy.getHistory_depth();
    }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(
                OpenDDSPackage.Literals.DURABILITY_SERVICE_QOS_POLICY__SERVICE_CLEANUP_DELAY, OpenDDSFactory.eINSTANCE
                        .createPeriod()));
    }
