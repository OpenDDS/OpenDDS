...
public class PresentationQosPolicyItemProvider extends QosPolicyItemProvider implements IEditingDomainItemProvider,
    ...
    protected void addAccess_scopePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                ...
                getString("_UI_PresentationQosPolicy_access_scope_feature"), getString(
                        "_UI_PropertyDescriptor_description", "_UI_PresentationQosPolicy_access_scope_feature",
                        "_UI_PresentationQosPolicy_type"),
                OpenDDSPackage.Literals.PRESENTATION_QOS_POLICY__ACCESS_SCOPE, true, false, false,
    ...
    protected void addCoherent_accessPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                .getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_PresentationQosPolicy_coherent_access_feature"), getString(
                        "_UI_PropertyDescriptor_description", "_UI_PresentationQosPolicy_coherent_access_feature",
                        "_UI_PresentationQosPolicy_type"),
                OpenDDSPackage.Literals.PRESENTATION_QOS_POLICY__COHERENT_ACCESS, true, false, false,
    ...
    protected void addOrdered_accessPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                .getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_PresentationQosPolicy_ordered_access_feature"), getString(
                        "_UI_PropertyDescriptor_description", "_UI_PresentationQosPolicy_ordered_access_feature",
                        "_UI_PresentationQosPolicy_type"),
                OpenDDSPackage.Literals.PRESENTATION_QOS_POLICY__ORDERED_ACCESS, true, false, false,
                ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
    }
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/PresentationQosPolicy"));
    }
    ...
    public String getText(Object object) {
        PresentationQosPolicyAccessScopeKind labelValue = ((PresentationQosPolicy) object).getAccess_scope();
