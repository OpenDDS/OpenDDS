...
public class WriterDataLifecycleQosPolicyItemProvider extends QosPolicyItemProvider implements
    ...
    protected void addAutodispose_unregistered_instancesPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                ...
                getString("_UI_WriterDataLifecycleQosPolicy_autodispose_unregistered_instances_feature"), getString(
                        "_UI_PropertyDescriptor_description",
                        "_UI_WriterDataLifecycleQosPolicy_autodispose_unregistered_instances_feature",
                        "_UI_WriterDataLifecycleQosPolicy_type"),
                OpenDDSPackage.Literals.WRITER_DATA_LIFECYCLE_QOS_POLICY__AUTODISPOSE_UNREGISTERED_INSTANCES, true,
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/WriterDataLifecycleQosPolicy"));
    }
    ...
    public String getText(Object object) {
        ...
        return getString("_UI_WriterDataLifecycleQosPolicy_type") + " "
                + writerDataLifecycleQosPolicy.isAutodispose_unregistered_instances();
    }
