 ...
 * @generated
 */
public class DataReaderWriterItemProvider extends DomainEntityItemProvider
	...
	protected void addDurabilityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_DataReaderWriter_durability_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_DataReaderWriter_durability_feature",
						"_UI_DataReaderWriter_type"),
				ModelPackage.Literals.DATA_READER_WRITER__DURABILITY, true,
	...
	protected void addDestination_orderPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_DataReaderWriter_destination_order_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_DataReaderWriter_destination_order_feature",
						"_UI_DataReaderWriter_type"),
				ModelPackage.Literals.DATA_READER_WRITER__DESTINATION_ORDER,
	...
	protected void addDeadlinePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_DataReaderWriter_deadline_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_DataReaderWriter_deadline_feature",
						"_UI_DataReaderWriter_type"),
				ModelPackage.Literals.DATA_READER_WRITER__DEADLINE, true,
				false, true, null, null, null));
	}
	...
	protected void addHistoryPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_DataReaderWriter_history_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_DataReaderWriter_history_feature",
						"_UI_DataReaderWriter_type"),
				ModelPackage.Literals.DATA_READER_WRITER__HISTORY, true, false,
				true, null, null, null));
	}
	...
	protected void addUser_dataPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_DataReaderWriter_user_data_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_DataReaderWriter_user_data_feature",
						"_UI_DataReaderWriter_type"),
				ModelPackage.Literals.DATA_READER_WRITER__USER_DATA, true,
				false, true, null, null, null));
	}
	...
	protected void addResource_limitsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_DataReaderWriter_resource_limits_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_DataReaderWriter_resource_limits_feature",
						"_UI_DataReaderWriter_type"),
				ModelPackage.Literals.DATA_READER_WRITER__RESOURCE_LIMITS,
				true, false, true, null, null, null));
	}
	...
	protected void addOwnershipPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_DataReaderWriter_ownership_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_DataReaderWriter_ownership_feature",
						"_UI_DataReaderWriter_type"),
				ModelPackage.Literals.DATA_READER_WRITER__OWNERSHIP, true,
				false, true, null, null, null));
	}
	...
	protected void addLivelinessPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_DataReaderWriter_liveliness_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_DataReaderWriter_liveliness_feature",
						"_UI_DataReaderWriter_type"),
				ModelPackage.Literals.DATA_READER_WRITER__LIVELINESS, true,
				false, true, null, null, null));
	}
	...
	protected void addLatency_budgetPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_DataReaderWriter_latency_budget_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_DataReaderWriter_latency_budget_feature",
						"_UI_DataReaderWriter_type"),
				ModelPackage.Literals.DATA_READER_WRITER__LATENCY_BUDGET, true,
				false, true, null, null, null));
	}
	...
	protected void addReliabilityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_DataReaderWriter_reliability_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_DataReaderWriter_reliability_feature",
						"_UI_DataReaderWriter_type"),
				ModelPackage.Literals.DATA_READER_WRITER__RELIABILITY, true,
				false, true, null, null, null));
	}
