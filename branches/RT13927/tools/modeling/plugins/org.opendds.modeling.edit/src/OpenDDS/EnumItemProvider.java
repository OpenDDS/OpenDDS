...
/**
 * This is the item provider adapter for a {@link OpenDDS.Enum}
 * object. <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class EnumItemProvider extends TopicFieldItemProvider implements IEditingDomainItemProvider,
    ...
    protected void addLabelsPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                .getRootAdapterFactory(), getResourceLocator(), getString("_UI_Enum_labels_feature"), getString(
                "_UI_PropertyDescriptor_description", "_UI_Enum_labels_feature", "_UI_Enum_type"),
                OpenDDSPackage.Literals.ENUM__LABELS, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
                null, null));
    }

    /**
     * This returns Enum.gif. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @generated
     */
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_Enum_type") : getString("_UI_Enum_type") + " "
                + label;
    }
