 ...
 * @generated
 */
public class ResourceLimitsQosPolicyItemProvider extends QosPolicyItemProvider
	...
	protected void addMax_instancesPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getResourceLocator(),
						getString("_UI_ResourceLimitsQosPolicy_max_instances_feature"),
						getString(
								"_UI_PropertyDescriptor_description",
								"_UI_ResourceLimitsQosPolicy_max_instances_feature",
								"_UI_ResourceLimitsQosPolicy_type"),
						ModelPackage.Literals.RESOURCE_LIMITS_QOS_POLICY__MAX_INSTANCES,
						true, false, false,
	...
	protected void addMax_samplesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_ResourceLimitsQosPolicy_max_samples_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_ResourceLimitsQosPolicy_max_samples_feature",
						"_UI_ResourceLimitsQosPolicy_type"),
				ModelPackage.Literals.RESOURCE_LIMITS_QOS_POLICY__MAX_SAMPLES,
				true, false, false,
				ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						((ComposeableAdapterFactory) adapterFactory)
								.getRootAdapterFactory(),
						getResourceLocator(),
						getString("_UI_ResourceLimitsQosPolicy_max_samples_per_instance_feature"),
						getString(
								"_UI_PropertyDescriptor_description",
								"_UI_ResourceLimitsQosPolicy_max_samples_per_instance_feature",
								"_UI_ResourceLimitsQosPolicy_type"),
						ModelPackage.Literals.RESOURCE_LIMITS_QOS_POLICY__MAX_SAMPLES_PER_INSTANCE,
						true, false, false,
						ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
	}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage(
				"full/obj16/ResourceLimitsQosPolicy"));
	}
	...
	public String getText(Object object) {
		...
		return getString("_UI_ResourceLimitsQosPolicy_type") + " "
				+ resourceLimitsQosPolicy.getMax_instances();
	}
