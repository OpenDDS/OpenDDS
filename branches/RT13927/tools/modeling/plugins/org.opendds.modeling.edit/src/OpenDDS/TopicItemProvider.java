 ...
 * @generated
 */
public class TopicItemProvider extends DomainEntityItemProvider implements
	...
	protected void addDurability_servicePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_Topic_durability_service_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_Topic_durability_service_feature",
						"_UI_Topic_type"),
				ModelPackage.Literals.TOPIC__DURABILITY_SERVICE, true, false,
				true, null, null, null));
	}
	...
	protected void addTransport_priorityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_Topic_transport_priority_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_Topic_transport_priority_feature",
						"_UI_Topic_type"),
				ModelPackage.Literals.TOPIC__TRANSPORT_PRIORITY, true, false,
				true, null, null, null));
	}
	...
	protected void addTopic_dataPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_Topic_topic_data_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_Topic_topic_data_feature", "_UI_Topic_type"),
				ModelPackage.Literals.TOPIC__TOPIC_DATA, true, false, true,
				null, null, null));
	}
	...
	protected void addResource_limitsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_Topic_resource_limits_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_Topic_resource_limits_feature", "_UI_Topic_type"),
				ModelPackage.Literals.TOPIC__RESOURCE_LIMITS, true, false,
				true, null, null, null));
	}
	...
	protected void addReliabilityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_Topic_reliability_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_Topic_reliability_feature", "_UI_Topic_type"),
				ModelPackage.Literals.TOPIC__RELIABILITY, true, false, true,
				null, null, null));
	}
	...
	protected void addOwnershipPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_Topic_ownership_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_Topic_ownership_feature", "_UI_Topic_type"),
				ModelPackage.Literals.TOPIC__OWNERSHIP, true, false, true,
				null, null, null));
	}
	...
	protected void addLivelinessPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_Topic_liveliness_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_Topic_liveliness_feature", "_UI_Topic_type"),
				ModelPackage.Literals.TOPIC__LIVELINESS, true, false, true,
				null, null, null));
	}
	...
	protected void addHistoryPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_Topic_history_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_Topic_history_feature", "_UI_Topic_type"),
				ModelPackage.Literals.TOPIC__HISTORY, true, false, true, null,
				null, null));
	}
	...
	protected void addDurabilityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_Topic_durability_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_Topic_durability_feature", "_UI_Topic_type"),
				ModelPackage.Literals.TOPIC__DURABILITY, true, false, true,
				null, null, null));
	}
	...
	protected void addDestination_orderPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						((ComposeableAdapterFactory) adapterFactory)
								.getRootAdapterFactory(), getResourceLocator(),
						getString("_UI_Topic_destination_order_feature"),
						getString("_UI_PropertyDescriptor_description",
								"_UI_Topic_destination_order_feature",
								"_UI_Topic_type"),
						ModelPackage.Literals.TOPIC__DESTINATION_ORDER, true,
	...
	protected void addDeadlinePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_Topic_deadline_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_Topic_deadline_feature", "_UI_Topic_type"),
				ModelPackage.Literals.TOPIC__DEADLINE, true, false, true, null,
				null, null));
	}
	...
	protected void addLatency_budgetPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_Topic_latency_budget_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_Topic_latency_budget_feature", "_UI_Topic_type"),
				ModelPackage.Literals.TOPIC__LATENCY_BUDGET, true, false, true,
				null, null, null));
	}
