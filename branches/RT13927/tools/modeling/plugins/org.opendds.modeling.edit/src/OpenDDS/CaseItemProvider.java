...
/**
 * This is the item provider adapter for a {@link OpenDDS.Case} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CaseItemProvider extends TopicFieldItemProvider implements
	...
	protected void addLabelsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_Case_labels_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_Case_labels_feature", "_UI_Case_type"),
				ModelPackage.Literals.CASE__LABELS, true, false, false,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_Case_type_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_Case_type_feature", "_UI_Case_type"),
				ModelPackage.Literals.CASE__TYPE, true, false, true, null,
				null, null));
	}
