...
public class CaseItemProvider extends TopicFieldItemProvider implements IEditingDomainItemProvider,
    ...
    protected void addLabelsPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                .getRootAdapterFactory(), getResourceLocator(), getString("_UI_Case_labels_feature"), getString(
                "_UI_PropertyDescriptor_description", "_UI_Case_labels_feature", "_UI_Case_type"),
                OpenDDSPackage.Literals.CASE__LABELS, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
                null, null));
    }
