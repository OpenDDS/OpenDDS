...
/**
 * This is the item provider adapter for a {@link OpenDDS.Publisher}
 * object. <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class PublisherItemProvider extends PublisherSubscriberItemProvider implements IEditingDomainItemProvider,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(OpenDDSPackage.Literals.PUBLISHER__WRITERS);
        }
    ...
    /**
     * This returns Publisher.gif. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @generated
     */
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_Publisher_type") : getString("_UI_Publisher_type")
                + " " + label;
    }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(OpenDDSPackage.Literals.PUBLISHER__WRITERS,
                OpenDDSFactory.eINSTANCE.createDataWriter()));
    }
