...
public class PeriodItemProvider extends ItemProviderAdapter implements
	...
	protected void addSecondsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_Period_seconds_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_Period_seconds_feature", "_UI_Period_type"),
				ModelPackage.Literals.PERIOD__SECONDS, true, false, false,
	...
	protected void addNanosecondsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_Period_nanoseconds_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_Period_nanoseconds_feature", "_UI_Period_type"),
				ModelPackage.Literals.PERIOD__NANOSECONDS, true, false, false,
				ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
	}
