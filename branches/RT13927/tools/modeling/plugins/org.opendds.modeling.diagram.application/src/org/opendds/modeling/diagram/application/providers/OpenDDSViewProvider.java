 ...
 * @generated
 */
public class OpenDDSViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return ApplicationModelEditPart.MODEL_ID.equals(op.getSemanticHint())
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = OpenDDSVisualIDRegistry.getNodeVisualID(op
					.getContainerView(), domainElement);
		} else {
			visualID = OpenDDSVisualIDRegistry
					.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				if (!OpenDDSElementTypes.isKnownElementType(elementType)
				...
				if (domainElement != null
						&& visualID != OpenDDSVisualIDRegistry.getNodeVisualID(
								op.getContainerView(), domainElement)) {
					return false; // visual id for node EClass should match
									// visual id from element type
				}
			} else {
				if (!ApplicationModelEditPart.MODEL_ID
						.equals(OpenDDSVisualIDRegistry.getModelID(op
								.getContainerView()))) {
		...
		return ApplicationTargetEditPart.VISUAL_ID == visualID;
	}
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = OpenDDSVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != OpenDDSVisualIDRegistry
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(ApplicationModelEditPart.MODEL_ID);
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			visualID = OpenDDSVisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
			visualID = OpenDDSVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case ApplicationTargetEditPart.VISUAL_ID:
			return createApplicationTarget_2001(domainElement, containerView,
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (OpenDDSVisualIDRegistry.getVisualID(elementTypeHint)) {
		case ApplicationTargetParticipantsEditPart.VISUAL_ID:
			return createApplicationTargetParticipants_4001(containerView,
					index, persisted, preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createApplicationTarget_2001(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(OpenDDSVisualIDRegistry
	 ...
	 * @generated
	 */
	public Edge createApplicationTargetParticipants_4001(View containerView,
		...
		edge.setType(OpenDDSVisualIDRegistry
	...
	private void stampShortcut(View containerView, Node target) {
		if (!ApplicationModelEditPart.MODEL_ID.equals(OpenDDSVisualIDRegistry
			...
			shortcutAnnotation.getDetails().put(
					"modelID", ApplicationModelEditPart.MODEL_ID); //$NON-NLS-1$
