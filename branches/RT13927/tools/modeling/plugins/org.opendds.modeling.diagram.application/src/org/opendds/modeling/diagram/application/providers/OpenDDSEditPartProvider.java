...
import org.opendds.modeling.diagram.application.edit.parts.OpenDDSEditPartFactory;
import org.opendds.modeling.diagram.application.part.OpenDDSVisualIDRegistry;

/**
 * @generated
 */
public class OpenDDSEditPartProvider extends AbstractEditPartProvider {
	 ...
	 * @generated
	 */
	public OpenDDSEditPartProvider() {
		setFactory(new OpenDDSEditPartFactory());
	...
	public synchronized boolean provides(IOperation operation) {
		if (operation instanceof CreateGraphicEditPartOperation) {
			...
			if (!ApplicationModelEditPart.MODEL_ID
					.equals(OpenDDSVisualIDRegistry.getModelID(view))) {
				return false;
			}
