 ...
 * @generated
 */
public class OpenDDSDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public OpenDDSDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof OpenDDSDomainNavigatorItem) {
			return wrapEObjects(myAdapterFctoryContentProvier
					.getChildren(((OpenDDSDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new OpenDDSDomainNavigatorItem((EObject) objects[i],
