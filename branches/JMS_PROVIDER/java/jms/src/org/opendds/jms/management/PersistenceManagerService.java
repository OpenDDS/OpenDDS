...
public class PersistenceManagerService extends DynamicMBeanSupport implements ServiceMBean {
    ...
    public PersistenceManagerService() {
        ...
        registerAttribute("Hbm2ddlAuto", "hibernate.jdbc.batch_size", String.class);
        registerAttribute("JdbcBatchSize", "hibernate.jdbc.batch_versioned_data", Integer.class);
        registerAttribute("JdbcBatchVersionedData", "hibernate.jdbc.fetch_size", Boolean.class);
        registerAttribute("JdbcFetchSize", "hibernate.jdbc.use_get_generated_keys", Integer.class);
        registerAttribute("JdbcUseGetGeneratedKeys", "hibernate.jdbc.use_scrollable_resultset", Boolean.class);
        registerAttribute("JdbcUseScrollableResultSet", "hibernate.jdbc.use_streams_for_binary", Boolean.class);
        registerAttribute("JdbcUseStreamsForBinary", "hibernate.hbm2ddl.auto", Boolean.class);
