...
OpenDDS is an open source C++ implementation of the Object Management Group (OMG) Data Distribution Service (DDS). Java applications can use OpenDDS through JNI bindings. OpenDDS is supported by [OCI](www.ociweb.com) and the source code is hosted on [GitHub]({{site.github.repository_url}}).
