 ...
 */
  ...
  {
    return register_instance_w_timestamp(instance, time_value_to_time(system_time()));
  }
  ...
  {
    return unregister_instance_w_timestamp(instance, handle, time_value_to_time(system_time()));
  }
  ...
  {
    return write_w_timestamp(instance_data, handle, time_value_to_time(system_time()));
  }
  ...
  {
    return dispose_w_timestamp(instance_data, instance_handle, time_value_to_time(system_time()));
  }
