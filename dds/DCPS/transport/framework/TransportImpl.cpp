...
InternalStatisticSeq TransportImpl::stats_template()
{
  static const DDS::UInt32 num_local_stats = 2;
  InternalStatisticSeq stats(num_local_stats);
...
void TransportImpl::fill_stats(InternalStatisticSeq& stats, DDS::UInt32& idx) const
{
  {
    GuardType guard(pending_connections_lock_);
