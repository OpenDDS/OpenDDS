...
private:
  ...
  public:
    explicit RtpsWriter(RcHandle<RtpsUdpDataLink> link, const RepoId& id, bool durable) : link_(link), id_(id), durable_(durable), ready_to_hb_(false), heartbeat_count_(0) {}
    ~RtpsWriter();
