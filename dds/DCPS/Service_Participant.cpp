...
{
  const String r = config_store->get(OPENDDS_COMMON_DCPS_DEFAULT_DISCOVERY,
...
{
  const DCPS::ConfigStoreImpl::StringList sections = config_store_->get_section_names("OPENDDS_DOMAIN");
