...
AgentImpl::AgentImpl()
  ...
  , task_task_(DCPS::make_rch<DCPS::SporadicEvent>(TheServiceParticipant->event_dispatcher(), DCPS::make_rch<DCPS::PmfNowEvent<AgentImpl> >(DCPS::rchandle_from(this), &AgentImpl::process_tasks)))
{
