...
bool ts_generator::generate_ts(AST_Decl* node, UTL_ScopedName* name)
{
  ...
  be_global->header_ <<
    ...
    "  typedef " << cxxName << "TypeSupportImpl TypeSupportImplType;\n"
  ...
  be_global->header_ << be_global->versioning_begin() << "\n";
  {
    ...
    be_global->header_ <<
      ...
      "\n"
      "  virtual const OpenDDS::XTypes::TypeIdentifierMap& getTypeIdentifierMap() const;\n"
      "\n"
  ...
  be_global->impl_ << be_global->versioning_begin() << "\n";
  {
    ...
    be_global->impl_ <<
      ...
      "}\n\n"
      "const OpenDDS::XTypes::TypeIdentifier& " << short_name << "TypeSupportImpl::getCompleteTypeIdentifier() const\n"
      "{\n"
      "  return OpenDDS::DCPS::getCompleteTypeIdentifier<OpenDDS::DCPS::" << typeobject_generator::tag_type(name) << ">();\n"
      "}\n\n"
      "const OpenDDS::XTypes::TypeMap& " << short_name << "TypeSupportImpl::getCompleteTypeMap() const\n"
      "{\n"
      "  return OpenDDS::DCPS::getCompleteTypeMap<OpenDDS::DCPS::" << typeobject_generator::tag_type(name) << ">();\n"
      "}\n\n"
      "const OpenDDS::XTypes::TypeIdentifierMap& " << short_name << "TypeSupportImpl::getTypeIdentifierMap() const\n"
      "{\n"
      "  return OpenDDS::DCPS::getTypeIdentifierMap<OpenDDS::DCPS::" << typeobject_generator::tag_type(name) << ">();\n"
      "}\n\n"
