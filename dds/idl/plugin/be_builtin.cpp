...
void BE_BuiltinInterface::usage()
{
  ...
  ACE_DEBUG((LM_DEBUG,
    ...
    ACE_TEXT(" --default-autoid\t\tset default XTypes autoid approach to sequential\n")
    ACE_TEXT("\t\t\t\tor hash (sequential if not set)\n")
    ...
    ACE_TEXT("\t\t\t\t--export=<macro> is an alternative form for this\n")
