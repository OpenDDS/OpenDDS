                        ...
                        const std::vector<AST_UnionBranch*>& branches)
  {
    ...
    }
    {
      ...
      be_global->impl_ <<
        ...
        "    ACE_CDR::Octet* const data = reinterpret_cast<ACE_CDR::Octet*>(param.wr_ptr());\n"
        "    if (!strm.read_octet_array(data, size)) {\n"
        "      return false;\n"
        "    }\n"
        "    param.wr_ptr(size);\n"
        "    Serializer strm2(&param, Encoding(Encoding::KIND_XCDR1, strm.swap_bytes()));\n"
