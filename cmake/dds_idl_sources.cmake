...
function(opendds_target_generated_dependencies target idl_file scope)
  ...
  set(idl_or_headers ${hdr_files})
  if (idl_ts_files)
    list(PREPEND idl_or_headers ${idl_ts_files})
  endif()
  opendds_add_idl_or_header_files(${target} ${scope} TRUE "${idl_or_headers}")
...
function(opendds_target_idl_sources target)
  ...
  foreach(input ${non_generated_idl_files})
    ...
    opendds_get_generated_idl_output(
      ${target} ${input} "${_ddsidl_cmd_arg_-o}" output_prefix output_dir)
