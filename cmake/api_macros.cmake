...
macro(OPENDDS_TARGET_SOURCES target)
  ...
  if(1)
    ...
    #get_filename_component(_cl_exe_path "${CMAKE_CXX_COMPILER}" PATH)
    cmake_path(_cl_exe_path "${CMAKE_CXX_COMPILER}" PATH)
    message("${_cl_exe_path} is CL_EXE_PATH")
    list(APPEND _opendds_options "-Yp,${_cl_exe_path}")
    message("${_opendds_options}")
  endif()

  if(1)
    message("WORLDWORLDWORLDWORLDWORLDWORLD")
    get_filename_component(_cl_exe_path "${CMAKE_CXX_COMPILER}" PATH)
    message("${_cl_exe_path} is CL_EXE_PATH")
    list(APPEND _tao_options "-Yp,${_cl_exe_path}")
