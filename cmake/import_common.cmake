...
function(_opendds_find_executables group exes)
  ...
  foreach(exe ${exes})
    ...
    set(host_tool_var "${var}_HOST_TOOL")
    set(is_host_tool "${${host_tool_var}}")

    if(TARGET "${target}")
      if(group_is_being_built AND NOT is_host_tool)
    ...
    set(mpc_projects_var "${group_prefix}_MPC_PROJECTS")
    if(DEFINED "${mpc_projects_var}" AND NOT is_host_tool)
      _opendds_find_in_mpc_projects(
