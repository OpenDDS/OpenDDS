...
if(DEFINED OPENDDS_PROFILING_COMPILER_ARGS)
  list(APPEND OPENDDS_ALL_LIBS_INTERFACE_COMPILE_OPTIONS "${OPENDDS_PROFILING_COMPILER_ARGS}")
endif()
if(DEFINED OPENDDS_PROFILING_LINKER_ARGS)
  list(APPEND OPENDDS_ALL_LIBS_INTERFACE_LINK_OPTIONS "${OPENDDS_PROFILING_LINKER_ARGS}")
endif()
