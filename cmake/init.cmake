...
include("${_opendds_config_cmake}" OPTIONAL RESULT_VARIABLE _opendds_included_config_cmake)
if(_opendds_included_config_cmake)
  message(STATUS "OpenDDS init.cmake included: ${_opendds_config_cmake}")
else()
  message(STATUS "OpenDDS init.cmake not found: ${_opendds_config_cmake}")
endif()
...
if(NOT _opendds_included_config_cmake AND NOT ACE_IS_BEING_BUILT)
  _opendds_detect_ace()
endif()
